...
export function WhatsAppIcon({
  ...
  return (
    <Svg width={size} height={size} viewBox={outline ? "0 0 448 512" : "0 0 24 24"} fill="none" accessibilityLabel="WhatsApp">
      {outline ? (
        <Path
        ...
        <>
          <Path
            d="M20.2 11.5a8.2 8.2 0 0 1-12.1 7.2L4 20l1.4-4A8.2 8.2 0 1 1 20.2 11.5Z"
            fill={color}
          />
          <Path
            d="M8.6 8.2c.2-.4.5-.6.9-.6h.5c.2 0 .4.1.5.4l.7 1.2c.1.3.1.5-.1.7l-.6.6c.7 1.2 1.6 2.1 2.8 2.8l.6-.6c.2-.2.5-.3.8-.1l1.2.7c.3.2.4.5.1.8-.4.6-1 .9-1.7 1-1.3.1-3.1-.8-4.4-2.1-1.4-1.4-2.3-3.2-2.2-4.5.1-.2.3-.3.9-.3Z"
            fill={markColor}
          />
        </>
      )}
